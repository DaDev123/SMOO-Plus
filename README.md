...
3. If you need to host an online server, head over to the [DSMOO](https://github.com/GrafDimenzio/DSMOO) repository and follow the instructions there to set up the server.
