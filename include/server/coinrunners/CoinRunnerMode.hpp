...
#include "server/coinrunners/CoinRunnerPackets.hpp"
...
class CoinRunnerMode : public GameModeBase {
    public:
        ...
        bool hasMarioCollision() override { return CoinRunnerInfo::mHasMarioCollision; }
        bool hasMarioBounce()    override { return CoinRunnerInfo::mHasMarioBounce;    }
        bool hasCappyCollision() override { return CoinRunnerInfo::mHasCappyCollision; }
        bool hasCappyBounce()    override { return CoinRunnerInfo::mHasCappyBounce;    }
    ...
    private:
        ...
        CoinRunnerInfo*  mInfo       = nullptr; // Our own Freeze-Tag status
