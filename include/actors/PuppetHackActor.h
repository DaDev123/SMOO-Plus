...
// TODO: Make this actor only created once per puppet, and use SubActorKeeper to create PartsModel
// actors for each capture
...
public:
    ...
    void startAction(sead::SafeString actName);
