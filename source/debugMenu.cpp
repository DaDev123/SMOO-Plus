...
static sead::Color4f bgColor(0.1f, 0.1f, 0.9f, 0.9f);
...
void setupDebugMenu(GameSystem* gSys) {
    ...
    if (al::isExistFile("SMOOsettings/DebugMenu.txt")) {
        bgColor = loadColorFromFile("SMOOsettings/DebugMenu.txt");
    }
...
void drawBackground(agl::DrawContext* context) {
    ...
    agl::utl::DevTools::drawTriangleImm(context, p1, p2, p3, bgColor);
    agl::utl::DevTools::drawTriangleImm(context, p3, p4, p2, bgColor);
}
