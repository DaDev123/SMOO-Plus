...
static void updateImGuiInput() {
    ...
    // Mouse position
    io.AddMousePosEvent(
        mouseState.mX / 1280.f * io.DisplaySize.x,
        mouseState.mY / 720.f  * io.DisplaySize.y
    );
    ...
    io.AddKeyEvent(ImGuiMod_Shift,
        keyboardState.mKeys.Test(int(nn::hid::KeyboardKey::LeftShift)) ||
        keyboardState.mKeys.Test(int(nn::hid::KeyboardKey::RightShift)));

    io.AddKeyEvent(ImGuiMod_Ctrl,
        keyboardState.mKeys.Test(int(nn::hid::KeyboardKey::LeftControl)) ||
        keyboardState.mKeys.Test(int(nn::hid::KeyboardKey::RightControl)));

    io.AddKeyEvent(ImGuiMod_Alt,
        keyboardState.mKeys.Test(int(nn::hid::KeyboardKey::LeftAlt)) ||
    ...
    {
        bool pressedNow =
            keyboardState.mKeys.Test(int(hidKey)) &&
           !lastKeyboardState.mKeys.Test(int(hidKey));
...
static void setup() {
    sImGuiHeap =
        sead::ExpHeap::create(6_MB, "ImGuiHeap", al::getStationedHeap(),
